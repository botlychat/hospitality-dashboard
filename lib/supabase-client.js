 ...
 */
async function getUnitGroups(orgId) {
  try {
    const { data, error } = await supabase
      .from('unit_groups')
      .select('*')
 ...
 */
async function getUnits(groupId) {
  try {
    const { data, error } = await supabase
      .from('units')
      .select('*')
 ...
 * @returns {Promise<Object>} Response
 */
async function upsertUnit(unitData, unitId = null) {
  try {
 ...
 */
async function getBookings(unitId) {
  try {
    const { data, error } = await supabase
      .from('bookings')
      .select('*')
 ...
 */
async function getAIAgentConfig(groupId) {
  try {
    const { data, error } = await supabase
 ...
 * @returns {Promise<Object>} Response
 */
async function saveAIAgentConfig(groupId, config) {
  try {
    const { data, error } = await supabase
      .from('ai_agent_configs')
      .upsert({
 ...
 */
async function getWebsiteConfig(groupId) {
  try {
    const { data, error } = await supabase
 ...
 * @returns {Promise<Object>} Response
 */
async function saveWebsiteConfig(groupId, config) {
  try {
    const { data, error } = await supabase
      .from('website_configs')
      .upsert({
...
// ============================================
// EXPORTS (Functions are globally available)
// ============================================
// All functions above are now available globally without export
